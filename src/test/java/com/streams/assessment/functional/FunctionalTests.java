...
import com.streams.assessment.OrderProcessing;
...
public class FunctionalTests {
	...
	@Test
	public void testProcessOrderDataWithHighValueOrders() {
		try {
			double[] total = orderProcessing.processOrderData(10);
			System.out.println(total[0] + " " + total[1] + " " + total[2]);
			yakshaAssert(currentTest(), 1471.413781877125 == total[0] ? "true" : "false", businessTestFile);
		} catch (IOException e) {
...
//import static com.streams.assessment.testutils.TestUtils.businessTestFile;
//import static com.streams.assessment.testutils.TestUtils.currentTest;
//import static com.streams.assessment.testutils.TestUtils.testReport;
//import static com.streams.assessment.testutils.TestUtils.yakshaAssert;
//
//import java.io.IOException;
